...
//this is the initial array set up for the funcion. multiple arrays should be used to account for varied answers
//and referenced within the function.
var questionsRight = arr["Hello! My name is RALPH, your Radical Adventure Leveraging Personal Helper!\nBut you can call me RALPH.\nLets see how well you pay attention.\nwhat's my name?,That's right! And what may I call you?,"]
...
while (count < 4) {
  if (count === 3) {
      ...
      alert("You should work for the circus! You guessed my age in " + count + " try! That's all for now, but you can be sure that I'll be around... watching...");
      bonus++
      break;
  } else if (ageGuess === 42) {
      alert("You should work for the circus! You guessed my age in " + count + " trys! That's all for now, but you can be sure that I'll be around... watching...");
      bonus++
      break;
  } else if (ageGuess < 42) {
      ++count;
